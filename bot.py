...
def validate_product_media(product):
    ...
    header, separator, encoded_data = media.partition(",")
    ...
    # Une donnée base64 occupe environ quatre tiers de la taille originale.
    estimated_size = (len(encoded_data.rstrip("=")) * 3) // 4
    return estimated_size <= MAX_MEDIA_SIZE_BYTES
